    ...
    <header class="h-16 flex justify-end items-center gap-5 md:gap-0 mb-3">
        ...
        <div class="hidden md:block w-[15vw] md:w-[43vw] lg:w-[33vw]">
            <div class="h-9 flex justify-end items-end gap-8 px-5">
                ...
                <img src="{{asset('Bell.svg')}}" alt="Notification" class="w-9 2xl:w-10 self-start">
                <div class="w-10 2xl:w-[2.75rem] relative cursor-pointer group self-start flex flex-col items-end">
