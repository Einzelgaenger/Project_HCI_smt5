...
<body>
    <div class="flex justify-center items-center py-[5vh] bg-gradient-to-b from-[#2c2c2c] to-[#0a0a0a]">
        <form action="" method="post" class="bg-[#121212] rounded-[8px] flex flex-col items-center justify-center gap-[2vh] h-[90vh] w-[60vw] md:w-[40vw] lg:w-[45vw] p-9 md:pt-12 lg:px-28">
            ...
            <div class="flex flex-col gap-[3vh] w-full">
                ...
                <p class="text-center text-white font-semibold">Don't have an account?&ensp;<a href="" class="text-center text-white font-semibold underline">Sign up for free!</a></p>
            </div>
        </form>
    </div>
</body>
