        ...
        <form action="{{route('login')}}" method="post" class="bg-[#121212] rounded-[8px] flex flex-col items-center justify-center gap-[2vh] h-[90vh] w-[60vw] md:w-[40vw] lg:w-[45vw] p-9 md:pt-12 lg:px-28">
            ...
            <div class="flex flex-col gap-[3vh] w-full">
                <div class="flex flex-col w-full gap-1">
                    ...
                    <input type="email" id="email" name="email" placeholder="Email" class="text-white w-full bg-transparent border-[0.5vw] md:border-[0.4vw] border-[#b3b3b3] lg:border-[0.3vw] 2xl:border-[0.2vw] rounded-md h-12 p-2">
                </div>
                <div class="flex flex-col w-full gap-1">
                    <label for="pass" class="text-white w-full font-semibold">Password</label>
                    <input type="password" id="pass" name="password" placeholder="Password" class="text-white w-full bg-transparent border-[0.5vw] md:border-[0.4vw] border-[#b3b3b3] lg:border-[0.3vw] 2xl:border-[0.2vw] rounded-md h-12 p-2">
                </div>
