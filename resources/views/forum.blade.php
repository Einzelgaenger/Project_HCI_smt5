        ...
        <div id="commentsSection">
            ...
            <div class="flex gap-8 my-4 items-center">
                <button class="flex gap-1 items-center text-[#999999]" onclick="location.href = '{{route('forum.show', $item->id)}}'">
                    <span class="reply-count mt-1"><img src="ChatCircle.svg" alt="reply" class="invert"></span> <span class="reply-count-number">12</span>
                </button>
                <button onclick="reportComment(this)"><img src="Prohibit.svg" alt="report" class="invert"></button>
            </div>
        </div>
        @endforeach
    </div>
