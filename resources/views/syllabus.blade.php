...
<div class="py-6 px-10">
    <x-title-card>
        ...
        <div class="w-4/12 mb-8 mt-4 mr-4">
            <x-details>
                <div class="h-5/6">
                    <p class="text-white text-xs sm:text-sm md:text-md lg:text-lg flex items-center gap-1 overflow-hidden"><img src="{{$syllabus->difficulty == 'Beginner Friendly' ? "CellSignalLow.svg" : ($syllabus->difficulty == 'Intermediate' ? "CellSignalMedium.svg" : "CellSignalHigh.svg")}}" class="w-6 sm:w-7">{{$syllabus->difficulty}}</p>
                    <hr class="my-1">
